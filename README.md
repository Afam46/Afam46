...
**Full-Stack разработчик (Laravel + Vue.js)**<br>
Студент КНИТУ-КХТИ (Казань)
...
## 🚀 Живой пример (деплой на VPS)
**[Nitro-Rush](http://155.212.147.12)** — гоночная игра с вебсокетами, очередями и кэшированием
